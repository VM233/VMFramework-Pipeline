...
- Capture public readonly authoring fields in legacy object graphs; native readback must
  account for their values instead of silently omitting them from migration evidence.
